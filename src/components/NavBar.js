...
import navIcon1 from '../assets/img/nav-icon1.svg'; // e.g., LinkedIn icon
import navIcon2 from '../assets/img/nav-icon2.svg'; // e.g., GitHub icon
import navIcon3 from '../assets/img/nav-icon3.svg'; // e.g., LeetCode icon
  ...
  return (
    <Router>
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Nav.Link href="#home" className="navbar-brand"> {/* Made logo clickable and redirect to home */}
